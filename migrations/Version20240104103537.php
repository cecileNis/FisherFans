 ...
 */
final class Version20240104103537 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `boat` (id INT AUTO_INCREMENT NOT NULL, port_id INT DEFAULT NULL, owner_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, brand VARCHAR(255) NOT NULL, year_of_fabrication INT NOT NULL, licence VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, equipment VARCHAR(255) NOT NULL, caution INT NOT NULL, capacity INT NOT NULL, number_of_beds INT NOT NULL, coords VARCHAR(255) NOT NULL, motorization VARCHAR(255) NOT NULL, power VARCHAR(255) NOT NULL, INDEX IDX_D86E834A76E92A9C (port_id), INDEX IDX_D86E834A7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
