 ...
 */
final class Version20231214133344 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `boat` (id INT AUTO_INCREMENT NOT NULL, port_id INT DEFAULT NULL, owner_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, marque VARCHAR(255) NOT NULL, date_of_fabrication DATETIME NOT NULL, licence VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, equipment VARCHAR(255) NOT NULL, caution INT NOT NULL, capacity INT NOT NULL, number_of_beds INT NOT NULL, details VARCHAR(255) NOT NULL, motorization VARCHAR(255) NOT NULL, power VARCHAR(255) NOT NULL, INDEX IDX_D86E834A76E92A9C (port_id), INDEX IDX_D86E834A7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, address_id INT DEFAULT NULL, company_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, date_of_birth DATETIME NOT NULL, phone_number VARCHAR(255) NOT NULL, language VARCHAR(255) NOT NULL, avatar VARCHAR(255) NOT NULL, licence VARCHAR(255) NOT NULL, insurance VARCHAR(255) NOT NULL, status TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D649F5B7AF75 (address_id), UNIQUE INDEX UNIQ_8D93D649979B1AD6 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
